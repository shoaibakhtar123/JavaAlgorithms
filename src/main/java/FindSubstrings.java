...
public class FindSubstrings {
    ...
    public static String getGreaterValue(String actualValue, String formattedValue) {
...
//                }
                ...
                selected.put(word, getGreaterValue(selected.get(word), formatted));
            }
        }

        for (int i = 0; i < words.length; i++) {
            if (selected.get(words[i]) != null){
                words[i] = selected.get(words[i]);
            }
        }
